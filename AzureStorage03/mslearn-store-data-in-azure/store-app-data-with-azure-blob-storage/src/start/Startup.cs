    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IStorage>(serviceProvider => {
                var logger = serviceProvider.GetService<ILogger<BlobStorage>>();
                var blobStorage = new BlobStorage(serviceProvider.GetService<IOptions<AzureStorageConfig>>(), logger);
